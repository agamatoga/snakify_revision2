...
Floor division will give you the exact number of desks rounded down that you need.

By doing modulo you will get the remaining amount of desks needed, i.e. if it doesn't divide evenly and 
then add that necessary amount still needed!
